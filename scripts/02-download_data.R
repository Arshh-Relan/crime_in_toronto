...
dir.create("~/Desktop/starter_folder-main-2/data/01-raw_data", recursive = TRUE, showWarnings = FALSE)

# Save the data to the raw_data folder
write_csv(data, "~/Desktop/starter_folder-main-2/data/01-raw_data/hate_crimes_raw_data.csv")
